...
class SQLChiperHelper(context: Context?, dbName: String, dbVersion: Int, password: String, private var listener: Listener.OnDatabaseListener) : SQLiteOpenHelper(context, dbName, null, dbVersion) {
